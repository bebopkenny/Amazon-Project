...
class Product {
  ...
  // Add properties and methods that are more specific to clothing
...
/*
const date = new Date();
date.toLocaleTimeString(); // current time
...
1. Inside a method, "this"
points to the outer object
this
const object3 = {
  method: () => {
    console.log(this);
...
2. Inside a function,
this = undefined but we change it
function logThis() {
  console.log(this);
}
logThis();
...
export function loadProductsFetch() {
  ...
  ).then((response) => { // makes an http request; makes a get request  
...
// Transforming each of the products into a class
/*
